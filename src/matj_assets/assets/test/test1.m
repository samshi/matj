...
permuteD2 = sum(permuteC2-permuteB2, 'all');						//210
checkEq(permuteD2, 0);
...
repmatA4 = (1:3)';
checkMt(sum(repmat(repmatA4,1,4),2), [4;8;12]);					//216
...
checkMt(rot90(rot90B4), rot90A);													//221
...
checkMt(size(nshiftsD), [1 4 3 2]);												//226
...
checkMt(diff(polyvalX3,1,2), [2	2;4	2;2	4]);						//243
