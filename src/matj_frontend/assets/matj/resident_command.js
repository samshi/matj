...
funcs = {
  Integration_and_Differentiation      : `
    积分与微分
  ...
  Plotting                             : `
    ...
    subplot(m,n,p),
    tiledlayout(m,n) Create axes in tiled positions
  ...
  Tables                               : `
    ...
    T(rows,columns),
    T(rows,["col1","coln"]) Create a new table with specified rows and columns from T
  ...
  `,
  Defining_and_Changing_Array_Variables: `
  ...
  `,
  Operators_and_Special_Characters     : `
...
// https://blog.csdn.net/nonmarking/article/details/20424997

// https://www.w3cschool.cn/matlab/matlab-vuh728jg.html