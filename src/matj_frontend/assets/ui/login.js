function createLogin(f) {
  ...
  P.buymecafe = $.C(P.support, {
    ...
    let amount = +prompt(
      "you will send author (accountId: 359646224d9cd82d26f73cc9dcddbaa041f13ee5802560b65f58db0ed02b8cf2) some ICP, gas fee 0.0001 ICP",
      0.1
    );
    if (
      typeof amount == "number" &&
      amount > 0 &&
      amount + 0.0001 <= DATA.icp_balance
    ) {
